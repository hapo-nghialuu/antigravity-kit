...
1. **Performance is Foundation, Not Feature** - Slow load times can drive users away
...
**Performance Targets:**
- App launch: <2 seconds; slow launches risk abandonment
...
**Quality:**
- Unit tests → Integration tests → E2E tests → Accessibility testing → Performance testing → Security audit
...
6. **No accessibility** - Can exclude users
...
- **Battery**: Minimize drain during active use
