...
function handleSessionCompacted(cwd: string): void {
  const lines = [
    ...
    "Any pending confirmations requested via the question tool might have been lost.",
    "Do not proceed without explicitly asking the user again to ensure safety.",
    'Use the question tool: "The chat context was compressed. Do I still have permission to proceed?"',
  ];
