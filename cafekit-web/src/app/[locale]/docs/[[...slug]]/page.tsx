  ...
  return (
    <div className="flex gap-8">
      ...
      {tocHeadings.length > 0 && (
        <aside className="hidden xl:block w-64 shrink-0 sticky top-[64px] h-[calc(100vh-4rem)] overflow-y-auto rounded-[24px] border border-border/70 bg-background/70 p-4 -mt-6 lg:-mt-8 backdrop-blur">
