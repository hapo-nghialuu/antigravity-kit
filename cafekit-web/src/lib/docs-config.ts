...
const labels: Record<Locale, DocsLabels> = {
  en: {
    ...
    pages: {
      ...
      workflows: page("Workflows", "Choose the right command: brainstorm, specs, develop, debug, fix, test, review, sync, docs, graph, git.", "commands workflows brainstorm debug fix"),
  ...
  vi: {
    ...
    pages: {
      ...
      workflows: page("Workflows", "Chọn đúng command: brainstorm, specs, develop, debug, fix, test, review, sync, docs, graph, git.", "commands workflows brainstorm debug fix"),
  ...
  ja: {
    ...
    pages: {
      ...
      workflows: page("Workflows", "brainstorm、specs、develop、debug、fix、test、review、sync、docs、graph、git の使い分け。", "commands workflows brainstorm debug fix"),
