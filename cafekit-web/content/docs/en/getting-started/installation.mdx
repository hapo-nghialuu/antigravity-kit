...
### For `/docs init` command (Claude Code)

To use the documentation generation command, you need [repomix](https://github.com/yamadashy/repomix) installed globally:
...
Repomix compacts your codebase into a single file that AI can analyze to generate accurate documentation.
