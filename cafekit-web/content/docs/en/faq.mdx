...
CafeKit Spec is a spec-driven development workflow for AI coding assistants. It provides 6 commands that guide you through building features with clear documentation and structure.

**Command formats by platform:**
...
| **[Antigravity](https://antigravity.google/)** | Available | Full support with `@` commands |
...
|-------|-------------|-------------|-------------|
| **Initialize** | `/spec-init` | `@spec-init` | Creates spec workspace |
| **Requirements** | `/spec-requirements` | `@spec-requirements` | AI asks questions to gather requirements |
| **Design** | `/spec-design` | `@spec-design` | Generates technical architecture document |
| **Tasks** | `/spec-tasks` | `@spec-tasks` | Breaks design into actionable tasks |
| **Implement** | `/spec-impl` | `@spec-impl` | Implements tasks with AI guidance |
| **Status** | `/spec-status` | `@spec-status` | Shows progress and next steps |
...
- **Browse [GitHub Issues](https://github.com/hapo-nghialuu/hapo-cafekit/issues)** - See if others had similar questions
