...
Learn from real-world spec examples. Each example shows the complete 6-phase workflow from initialization to implementation.

## Available Examples

### [User Authentication](/docs/examples/user-authentication)

JWT-based authentication with login, signup, and password reset. Shows security considerations and error handling.

**Technologies:** Node.js, JWT, Security
...
- Open a PR on [GitHub](https://github.com/vudovn/cafekit)
- Follow the existing example format
- Include all 6 phases of the workflow
