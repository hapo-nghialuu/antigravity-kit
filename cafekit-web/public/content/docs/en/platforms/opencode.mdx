---
title: OpenCode
description: Self-contained CafeKit runtime for OpenCode projects.
---

<DocsHero
  eyebrow="Platforms · OpenCode"
  title="Self-contained `.opencode/` runtime with TypeScript plugins."
  description="CafeKit installs a complete OpenCode runtime that does not share files with `.claude/`. Hooks become typed plugins loaded by OpenCode at session start."
/>
