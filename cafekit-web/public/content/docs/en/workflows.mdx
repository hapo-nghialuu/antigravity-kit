...
| Command | Use when |
|---|---|
| `/hapo:brainstorm` | The idea is unclear, architectural choices are open, or scope needs pressure-testing. |
...
| `/hapo:sync` | `spec.json` and task markdown drift or need audit. |
