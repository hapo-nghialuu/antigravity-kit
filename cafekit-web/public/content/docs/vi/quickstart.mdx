...
<Callout type="info">**Mới biết CafeKit?** Trang này dành cho người đã hiểu workflow. Nếu bạn bắt đầu từ con số 0, hãy theo [hướng dẫn từng bước](/docs/tutorial) — dắt tay từ chưa cài gì đến feature đầu tiên đã verify.</Callout>
