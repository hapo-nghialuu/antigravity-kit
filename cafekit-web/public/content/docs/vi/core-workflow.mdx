...
<DocsHero
  ...
  description="Workflow delivery của CafeKit bắt đầu từ specs: viết contract, khóa task packet, implement một boundary, verify bằng evidence thật, review đối kháng, rồi sync state."
/>
...
| Production bug cần fix hẹp | `/hapo:fix` sau diagnosis có evidence. |
